...
public class ExceptionDemo {
	 ...
	 * data will occur. It is more straightforward to understand what this code is
	 * trying to do, and hence easier to debug.
	 */
	...
	/**
	 * This is much easier to read. The try block is as uncluttered as the uncaught
	 * demo, and always makes sure the Scanner is closed. However, we are not
	 * catching cases with negative values and the output is not user-friendly!
	 */
	 ...
	 * Scanner object removes the necessity of the finally block. We added back in a
	 * little bit of validation where necessary, and made the catch blocks more
