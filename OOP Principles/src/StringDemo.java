...
public class StringDemo {
	...
	public static void main(String[] args) {
		 ...
		 * considered equivalent to each other. We actually want this behavior---if the
		 * String objects have the same value, they should be considered equivalent.
		 */
		...
		/*
		 * But, the hash code here is misleading. Any class can override this method to
		 * return something OTHER than the identity hashcode (e.g. memory
		 * location/unique object identifier). To view the actual identity hashcode, you
		 * must use the identityHashCode() method whenever dealing with a class other
		 * than Object.
		 */
		...
		/*
		 * Note that equals() and == no longer do the same operation. The String class
		 * overrode equals() to compare by content. But, the == operator still compares
		 * by identity hashcode!
		 */
		...
		/*
		 * Be very aware of the difference between equals() and == when you are doing
		 * any kind of comparison. Most of the time, classes will override equals() to
		 * compare by value, not the identity hashcode. But the == operator will
		 * *always* compare by identity hashcode.
		 */
	}
}
