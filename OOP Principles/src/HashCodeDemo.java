...
public class HashCodeDemo {
	...
	public static void main(String[] args) {
		 ...
		 *
		 * When changing the value of an immutable object, you are actually creating a
		 * new object. The reference to the old object is broken and updated to the new
		 * object. The garbage collector will clean up the now unused space of the old
		 * object.
		 *
		 * Notice how the memory address changes once the Integer value is modified and
		 * reassigned! The original Integer object is not being modified.
		 */
