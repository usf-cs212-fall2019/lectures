...
public class MutabilityDemo {
	...
	public static void main(String[] args) {
		 ...
		 * modifying the memory already allocated to that array.
		 */
		 ...
		 *
		 * Since arrays are also mutable, whenever we change the value in memory, all
		 * references to that memory will see this change.
		 */
