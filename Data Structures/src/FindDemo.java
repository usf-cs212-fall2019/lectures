...
public class FindDemo {
	...
	private static void listDemo() {
		...
		for (String letter : letters) {
			 ...
			 * letters that do not exist in our list.
			 *
			 ...
			 * insert the letter "a" into our sorted list, it should be at the front.
			 *
	 ...
	 * set that start with the specified letter. For example, how to find all of the
	 * words in animals that starts with the letter "a".
	 */
	private static void tailsetDemo() {
		...
		for (String letter : letters) {
			...
			for (String animal : set.tailSet(letter)) {
				 ...
				 * right place. Once we no longer have a word that starts with our letter, we
