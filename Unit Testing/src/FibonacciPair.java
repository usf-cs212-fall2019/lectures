...
public class FibonacciPair {
	...
	/**
	 * Initializes a Fibonacci pair for a specific sequence index. For example, for
	 * the Fibonacci sequence 0, 1, 1, 2, 3, ... the Fibonacci number at index 0 is
	 * 0 and the Fibonacci number at index 1 and index 2 is 1.
	 *
	...
	public FibonacciPair next() {
		 ...
		 *   Correct: return new FibonacciPair(index + 1, current, previous.add(current));
		 * Incorrect: return new FibonacciPair(index + 1, previous, previous.add(current));
		 *
...
//		return new FibonacciPair(index + 1, current, previous.add(current));
	...
	/*
	 * TODO Intentionally make a mistake here.
	 *   Correct: public static FibonacciPair F1 = new FibonacciPair(1, 0, 1);
	 * Incorrect: public static FibonacciPair F1 = new FibonacciPair(1, 1, 1);
	 *
...
//	public static FibonacciPair F1 = new FibonacciPair(1, 0, 1);
	...
	public static Stream<FibonacciPair> stream() {
		/*
		 * TODO Intentionally make a mistake here.
		 *   Correct: return Stream.concat(Stream.of(F0), Stream.iterate(F1, fn -> fn.next()));
		 * Incorrect: return Stream.iterate(F1, fn -> fn.next());
		 *
		 * (Detected by testFibonacciNumber and others)
		 */
