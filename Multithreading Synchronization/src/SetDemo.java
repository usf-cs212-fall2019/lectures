...
public class SetDemo {
	...
	public static double benchmark(int size) throws InterruptedException {
		...
		System.out.printf(format, set2.getClass().getSimpleName(), speed1, average2 < average1 ? "faster" : "slower", set1.getClass().getSimpleName());
		System.out.printf(format, set3.getClass().getSimpleName(), speed3, average3 < average1 ? "faster" : "slower", set1.getClass().getSimpleName());
		System.out.printf(format, set3.getClass().getSimpleName(), speed2, average3 < average2 ? "faster" : "slower", set2.getClass().getSimpleName());
