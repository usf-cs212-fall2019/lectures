 ...
 *
 * @see <a href=
 *      "https://wiki.sei.cmu.edu/confluence/pages/viewpage.action?pageId=88487666">SEI
 *      CERT Oracle Coding Standard for Java</a>
 */
...
//		worker2 = new Worker(new Object());
		...
		public void run() {
			synchronized (lock) {
				...
				try {
					...
					// Thread.sleep(...) is used for demonstration purposes, but rarely otherwise.
					Thread.sleep(1000);
				}
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 * lock/key used. If there are not enough "keys" then threads will become
		 * blocked.
		 */
	}
}
